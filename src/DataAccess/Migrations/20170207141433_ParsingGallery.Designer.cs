...
namespace DataAccess.Migrations
{
    ...
    [Migration("20170207141433_ParsingGallery")]
    partial class ParsingGallery
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("DataAccess.Models.ParsedGallery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<bool>("Fjord");

                    b.Property<int>("GalleryId");

                    b.Property<bool>("IsExpunged");

                    b.Property<int>("ParsingStateId");
            ...
            modelBuilder.Entity("DataAccess.Models.SearchResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("DataAccess.Models.ParsedGallery", b =>
                {
                    b.HasOne("DataAccess.Models.ParsingState", "ParsingState")
                        .WithOne("ParsedGallery")
                        .HasForeignKey("DataAccess.Models.ParsedGallery", "ParsingStateId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
